      ...
      <div class="hero-device-wrap">
        ...
        <div class="hero-device">
          <div class="phone-frame">
            ...
            <img src="/screenshots/dashboard-updated.PNG" alt="PottyTime Dashboard">
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="screenshot-stage">
      <div class="screenshot-slot stagger-left" onclick="openLightbox(0)">
        <div class="device-frame">
          <img src="/screenshots/dashboard-updated.PNG" alt="PottyTime Dashboard" loading="lazy">
          <div class="screenshot-label"><span>Dashboard</span></div>
        </div>
      </div>
      <div class="screenshot-slot stagger-center" onclick="openLightbox(1)">
        <div class="device-frame">
          <img src="/screenshots/quick-log-updated.PNG" alt="PottyTime Quick Log" loading="lazy">
    ...
    <div class="watch-inner">
      ...
      <div class="watch-devices">
        <div class="watch-phone-frame">
          <img src="/screenshots/dashboard-updated.PNG" alt="PottyTime iPhone" loading="lazy">
        </div>
